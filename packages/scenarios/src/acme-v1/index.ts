 ...
 */
export const ACME_V1_SIZES = { products: 120, customers: 40, orders: 300, transfers: 60 } as const;

export const acmeV1: Scenario = {
  key: "acme-v1",
  description: "Industrial-supply company: 120 products across 4 depots, 40 customers, 300 orders, 60 transfers.",
